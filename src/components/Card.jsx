...
const Card = ({Key,id,Title, image, details }) => {
  ...
  return (
    <>
      <section className="flex flex-col w-max rounded-lg p-2 items-center h-full ring-1 ring-white/15 gap-2 bg-black" key={Key}>
        <div className="flex justify-start w-full"> {Title}</div>
